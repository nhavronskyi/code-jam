...
class UserServiceTest {
    ...
    @Test
    void registerUser_ShouldThrowException_WhenPasswordHasNoLetters() {
        // Given
        String email = "newuser@example.com";
    ...
    @Test
    void registerUser_ShouldThrowException_WhenPasswordHasNoDigits() {
        // Given
        String email = "newuser@example.com";
    ...
    @Test
    void registerUser_ShouldAcceptValidPassword_WithLettersAndDigits() {
        // Given
        String email = "newuser@example.com";
        String password = "validPass123";
        String hashedPassword = "hashedValidPass123";
    ...
    @Test
    void registerUser_ShouldAcceptComplexPassword() {
        // Given
        String email = "newuser@example.com";
        String password = "ComplexP@ssw0rd123!";
        String hashedPassword = "hashedComplexPassword";
